...
{
  echo "<script>alert('user Data has been Delete Successfully');</script>";
}
...
$last_log="";
include 'lib/db.php';
     $run_query1=mysqli_query($conn,"SELECT * FROM `user_add`");
     foreach($run_query1 as $row)

     {
        $buyer_name1[]=$row['BUYER_NAME'];
        $username2[]=$row['USER_NAME'];
        $userid3[]=$row['USERID_ID'];
       
       $user_id4[]=$row['ID'];
       $email5[]=$row['EMAIL_ID'];
       $mobile6[]=$row['MOBILE_NO'];

       $password7[]=$row['PASS_WORD'];

       $address8[]=$row['ADDRESS'];
       $user_city9[]=$row['CITY'];
       $user_state10[]=$row['STATE'];
      $user_country11[]=$row['COUNTRY'];
      
       $last_log12[]=$row['LAST_LOGIN_ACTIVITY'];
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>One View user</h3>
...
include 'lib/db.php';
  ...
  $search_id=mysqli_query($conn,"SELECT COUNT(ID)  FROM `user_add`;");
  //$new_id=100;
...
echo "<th></th>
                ...
                <tbody>
                  ...
                  <td >$username2[$no]</td>
                   ...
                   <td>$email5[$no]</td>
                    ...
                    <td>$mobile6[$no]</td>
                    <td>$address8[$no]</td>
                    <td>$user_country11[$no]</td>
                   
                    <td>$user_state10[$no]</td>
                    <td>$user_city9[$no]</td>
                    ...
                    <td> 
                      ...
                      <a href='?id=$user_id12[$no]'  data-js='open' class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></a>
                      <a href='?id=$user_id12[$no]#popup1'  data-js='open'  class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i></button></td>
                    <td>";
	...
	<div id="popup1" class="overlay">
      ...
      <center><img src="images/sent.png" alt="" width="50" height="46"></center>
                        ...
                        <center><div class="m-t-20"> <a href="user-view.php" class="btn btn-danger" class="btn btn-white" >Close</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <?php echo "<a href='user_delete/user-delete_data.php?final_delid=$ID' class='btn btn-danger'>Delete</a>"; ?>
                                </center>
</div>
		</div>
	</div>
