    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h5 class="centered">Last Login</h5>
          <h5 class="centered"><?php echo $last_activity;?></h5>
          <li class="mt">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
            <li><a href="buyer-view.php">View Buyer</a></li>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        ...
        title: 'Welcome to PP Associates!',
