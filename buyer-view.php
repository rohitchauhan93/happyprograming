...
{
  echo "<script>alert('Buyer Data has been Delete Successfully');</script>";
}
...
$last_log="";
include 'lib/db.php';
     $run_query1=mysqli_query($conn,"SELECT * FROM `buyer_add`");
     foreach($run_query1 as $row)
     {
        $buyername[]=$row['BUYER_NAME'];
        $buyerid[]=$row['BUYER_ID'];
        $buyer_user[]=$row['USER_ID'];
       $buyer_password1[]=$row['PASS_WORD'];
       $buyer_contactp2[]=$row['CONTACT_PERSON'];
       $email3[]=$row['EMAIL_ID'];
       $buyer_mobile4[]=$row['MOBILE_NO'];
       $address5[]=$row['ADDRESS'];
       $buyer_city6[]=$row['CITY'];
       $buyer_state7[]=$row['STATE'];
      $buyer_country8[]=$row['COUNTRY'];
       $buyer_currency9[]=$row['CURRENCY'];
       $logo10[]=$row['LOGO_IMG'];
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>One View Buyer</h3>
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i>Buyers List</h4>
                <hr>
                <thead>
                  <tr>
                    <!---<th><i></i>ID</th>--->
...
include 'lib/db.php';
  ...
  $search_id=mysqli_query($conn,"SELECT COUNT(SR_NO)  FROM `buyer_add`;");
  //$new_id=100;
...
echo "<th></th>
                ...
                <tbody>
                  <tr>
                   <!--- <td>
                    ...
                    <td >$buyername[$no]</td>
                    <td>$buyer_user[$no]</td>
                    <td>$buyer_password1[$no]</td>
                    <td>$buyer_contactp2[$no]</td>
                    
                    <td>$buyer_mobile4[$no]</td>
                    <td>$address5[$no]</td>
                    <td>$buyer_city6[$no]</td>
                    <td>$buyer_state7[$no]</td>
                    <td>$buyer_country8[$no]</td>
                    <td>$buyer_currency9[$no]</td>
                    <td>$last_log11[$no]</td>
                    <td ><img src='Logo_images/$logo10[$no]' height='60' width='60'></td>
                    <td> 
                    
                      <a href='?id=$buyerid[$no]'  data-js='open' class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></a>
                      <a href='?id=$buyerid[$no]#popup1'  data-js='open'  class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i></button></td>
                    <td>";
	...
	<div id="popup1" class="overlay">
      ...
      <center><img src="images/sent.png" alt="" width="50" height="46"></center>
                        ...
                        <center><div class="m-t-20"> <a href="buyer-view.php" class="btn btn-danger" class="btn btn-white" >Close</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <?php echo "<a href='buyer_delete/buyer-delete_data.php?final_delid=$ID' class='btn btn-danger'>Delete</a>"; ?>
                                </center>
</div>
		</div>
	</div>
