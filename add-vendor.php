...
if(isset($_GET['checked_p1']))
{
  ...
  echo "<script>alert('Add vendor Successful')</script>";
}
...
if(isset($_GET['checked_p2']))
{
  ...
  echo "<script>alert('vendor Name or Email Id Already Registered')</script>";
}
...
<script>
    $(document).ready(function(){
        ...
        // This is incase the vendor hits refresh - some browsers will maintain the disabled state of the button.
...
function checkAvailability() {
	$("#loaderIcon").show();
	jQuery.ajax({
	url: "live_userid_vendor/check_availability.php",
  ...
  <section id="container">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="img/PP-A.jpeg" class="img-circle" width="80"></a></p>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Add-vendor</h3>
        ...
        <div class="row mt">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form action="Add-vendor_db.php" class="form-horizontal style-form" Method="POST" enctype="multipart/form-data">
    ...
    $query = $conn->query("SELECT * FROM `buyer_add` ORDER BY SR_NO ASC");
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3 col-xs-11">
                      <div data-date-minviewmode="months" class="input-append date dpMonths">
                        ...
                        <input type="text"   size="16" class="form-control" name="vendor_name" Required>
                        <span class="input-group-btn add-on">
                    ...
                    <div class="col-md-3 col-xs-11">
                      <div data-date-minviewmode="months" class="input-append date dpMonths">
                        ...
                        <input type="text"   size="16" class="form-control" name="vendor_code" Required>
                        <span class="input-group-btn add-on">
                    ...
                    <div class="col-md-3 col-xs-11">
                      <div data-date-minviewmode="months" class="input-append date dpMonths">
                        ...
                        <input type="text"   size="16" class="form-control" name="contactp" Required>
                        <span class="input-group-btn add-on">
...
?>
                ...
                <option >Select State</option>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                        <label class="control-label col-md-3">Vendor Client Code</label>
                        <div class="col-md-3 col-xs-11">
                          <div data-date-minviewmode="months" class="input-append date dpMonths"></div>
                            <input type="text"   size="16" class="form-control" name="vendor_client">
                            <span class="input-group-btn add-on">
                ...
                <input type="submit" value="Submit" class="btn btn-danger" name="Add-vendor">
