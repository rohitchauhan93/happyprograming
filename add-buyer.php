...
if(isset($_GET['checked_p1']))
{
  ...
  echo "<script>alert('Add Buyer Successful')</script>";
}
...
if(isset($_GET['checked_p2']))
{
  ...
  echo "<script>alert('Email-id  or Mobile No. Already Registered')</script>";
}
if(isset($_GET['checked_p3']))
{
  

  echo "<script>alert('File is not an image.')</script>";
}
if(isset($_GET['checked_p4']))
{
  

  echo "<script>alert('Sorry, file already exists.')</script>";
}
if(isset($_GET['checked_p5']))
{
  

  echo "<script>alert('Sorry, your file is too large.')</script>";
}
if(isset($_GET['checked_p6']))
{
...
function checkAvailability() {
	$("#loaderIcon").show();
	jQuery.ajax({
	url: "live_userid_buyer/check_availability.php",
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Add-Buyer</h3>
        ...
        <div class="row mt">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form action="add-buyer_db.php" class="form-horizontal style-form" Method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  <label class="control-label col-md-3">Buyer Name *</label>
                  <div class="col-md-3 col-xs-11">
                    <input class="form-control" size="16" type="text"  name="buyer_name" Required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <div data-date-minviewmode="months" class="input-append date dpMonths"></div>
                      <input type="text"   size="16" class="form-control" name="pass_word" Required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3 col-xs-11">
                      <div data-date-minviewmode="months" class="input-append date dpMonths">
                        ...
                        <input type="text"   size="16" class="form-control" name="contact">
                        <span class="input-group-btn add-on">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-xs-11">
                          <div data-date-minviewmode="months" class="input-append date dpMonths"></div>
                            <input type="text"   size="16" class="form-control" name="phone" Required> 
                            <span class="input-group-btn add-on">
...
?>
                ...
                <option value="" >Select State</option>
                          ...
                          <div class="form-group">
                          <label class="control-label col-md-3">Logo img(180*108PX)</label>
                          <div class="col-md-3 col-xs-11">
                            <div data-date-minviewmode="months" class="input-append date dpMonths"></div>
                              <input type="file"   size="16" class="form-control" name="file">
                              <span class="input-group-btn add-on">
